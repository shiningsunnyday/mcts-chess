...
from games.monochromatic.MonochromaticChessLogic import MonochromaticChessBoard as Board
import numpy as np
import time
import hashlib

class MonochromaticChessGame(Game):
    ...
    def getInitBoard(self):
        sys.setrecursionlimit(MonochromaticChessGame.RECURSION_LIMIT)
